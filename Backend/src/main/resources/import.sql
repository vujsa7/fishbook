...
insert into entity (id, name, description, address_id, price_per_day, cancellation_fee, is_deleted, owner_id, rating) values (nextval('entity_id_seq'), 'Lake Pleasant', 'Located in the northwest Valley about 45 minutes from downtown Phoenix, Lake Pleasant is always bustling with a variety of water sports and outdoor enthusiasts. The 10,000-acre lake is enjoyed by windsurfers, boaters, sailors, water and jet skiers, and fishermen. Lake Pleasant Regional Park also offers camping and trails for mountain biking and hiking.', 1, 72.0, 10, false, 4, 0.0)
...
insert into entity (id, name, description, address_id, price_per_day, cancellation_fee, is_deleted, owner_id, rating) values (nextval('entity_id_seq'), 'Hawaii Paradise', 'Somewhere in Hawaii, these is a magical house Hawaii Paradise that features amazing scenery and jungle vibes. Ocean is nearby if you want to take a swim and there are free surf boards in the house.', 6, 150.0, 10, false, 3, 0.0)
...
insert into entity (id, name, description, address_id, price_per_day, cancellation_fee, is_deleted, owner_id, rating) values (nextval('entity_id_seq'), 'Godzilla 3.1', 'Great fast boat with barbecue grill and three fridges. Good for long sailing across the sea.', 7, 120.0, 5, false, 2, 0.0)
...
insert into entity (id, name, description, address_id, price_per_day, cancellation_fee, is_deleted, owner_id, rating) values (nextval('entity_id_seq'),'Diamond', 'Like the name suggests, this boat is like a diamond in the sea. If you are a couple this is the perfect boat for you.', 9, 110.0, 10, false, 2, 0.0)
